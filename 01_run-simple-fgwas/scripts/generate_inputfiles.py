...
"""
# Create agesex
agesex = baseline[["FID","IID","AGE","MALE"]].replace(
...
phenotype = baseline.drop(["AGE","MALE","YEAR_RECRUITED","MONTH_RECRUITED","COYOACAN","MARITAL_STATUS"],axis=1)
phenotype.iloc[:, 2:] = phenotype.iloc[:, 2:].fillna(-9) # nulls as described `here <http://zzz.bwh.harvard.edu/plink/data.shtml#pheno>`
